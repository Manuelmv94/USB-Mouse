...
reg32 * CapSense_pcTable[] = {
    (reg32 *)CapSense_Sns__Left__BTN__PC, 
    (reg32 *)CapSense_Sns__Right__BTN__PC, 
    (reg32 *)CapSense_Sns__Up__BTN__PC, 
    (reg32 *)CapSense_Sns__Down__BTN__PC, 
    (reg32 *)CapSense_Sns__Centre__BTN__PC, 
    (reg32 *)CapSense_Sns__RadialSlider0_e0__RS__PC, 
    (reg32 *)CapSense_Sns__RadialSlider0_e1__RS__PC, 
    (reg32 *)CapSense_Sns__RadialSlider0_e2__RS__PC, 
    (reg32 *)CapSense_Sns__RadialSlider0_e3__RS__PC, 
    (reg32 *)CapSense_Sns__RadialSlider0_e4__RS__PC, 
    (reg32 *)CapSense_Sns__RadialSlider0_e5__RS__PC, 
    (reg32 *)CapSense_Sns__RadialSlider0_e6__RS__PC, 
    (reg32 *)CapSense_Sns__RadialSlider0_e7__RS__PC, 
};

const uint8 CapSense_portTable[] = {
    CapSense_Sns__Left__BTN__PORT, 
    CapSense_Sns__Right__BTN__PORT, 
    CapSense_Sns__Up__BTN__PORT, 
    CapSense_Sns__Down__BTN__PORT, 
    CapSense_Sns__Centre__BTN__PORT, 
    CapSense_Sns__RadialSlider0_e0__RS__PORT, 
    CapSense_Sns__RadialSlider0_e1__RS__PORT, 
    CapSense_Sns__RadialSlider0_e2__RS__PORT, 
    CapSense_Sns__RadialSlider0_e3__RS__PORT, 
    CapSense_Sns__RadialSlider0_e4__RS__PORT, 
    CapSense_Sns__RadialSlider0_e5__RS__PORT, 
    CapSense_Sns__RadialSlider0_e6__RS__PORT, 
    CapSense_Sns__RadialSlider0_e7__RS__PORT, 
};

const uint32 CapSense_maskTable[] = {
    CapSense_Sns__Left__BTN__MASK, 
    CapSense_Sns__Right__BTN__MASK, 
    CapSense_Sns__Up__BTN__MASK, 
    CapSense_Sns__Down__BTN__MASK, 
    CapSense_Sns__Centre__BTN__MASK, 
    CapSense_Sns__RadialSlider0_e0__RS__MASK, 
    CapSense_Sns__RadialSlider0_e1__RS__MASK, 
    CapSense_Sns__RadialSlider0_e2__RS__MASK, 
    CapSense_Sns__RadialSlider0_e3__RS__MASK, 
    CapSense_Sns__RadialSlider0_e4__RS__MASK, 
    CapSense_Sns__RadialSlider0_e5__RS__MASK, 
    CapSense_Sns__RadialSlider0_e6__RS__MASK, 
    CapSense_Sns__RadialSlider0_e7__RS__MASK, 
};

const uint8 CapSense_pinShiftTbl[] = {
    (uint8) CapSense_Sns__Left__BTN__SHIFT, 
    (uint8) CapSense_Sns__Right__BTN__SHIFT, 
    (uint8) CapSense_Sns__Up__BTN__SHIFT, 
    (uint8) CapSense_Sns__Down__BTN__SHIFT, 
    (uint8) CapSense_Sns__Centre__BTN__SHIFT, 
    (uint8) CapSense_Sns__RadialSlider0_e0__RS__SHIFT, 
    (uint8) CapSense_Sns__RadialSlider0_e1__RS__SHIFT, 
    (uint8) CapSense_Sns__RadialSlider0_e2__RS__SHIFT, 
    (uint8) CapSense_Sns__RadialSlider0_e3__RS__SHIFT, 
    (uint8) CapSense_Sns__RadialSlider0_e4__RS__SHIFT, 
    (uint8) CapSense_Sns__RadialSlider0_e5__RS__SHIFT, 
    (uint8) CapSense_Sns__RadialSlider0_e6__RS__SHIFT, 
    (uint8) CapSense_Sns__RadialSlider0_e7__RS__SHIFT, 
};
...
const uint8 CapSense_widgetNumber[CapSense_TOTAL_SENSOR_COUNT] = {
    ...
    4u, /* Down__BTN */
    5u, /* Centre__BTN */
    0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, /* RadialSlider0__RS */
};
