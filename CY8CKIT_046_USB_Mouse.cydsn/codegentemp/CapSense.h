...
#define CapSense_TOTAL_SENSOR_COUNT            (13u)
#define CapSense_TOTAL_SCANSLOT_COUNT          (13u)
#define CapSense_INDEX_TABLE_SIZE              (0u)

/* Define Sensors */
#define CapSense_SENSOR_LEFT__BTN    (0u)
#define CapSense_SENSOR_RIGHT__BTN    (1u)
#define CapSense_SENSOR_UP__BTN    (2u)
#define CapSense_SENSOR_DOWN__BTN    (3u)
#define CapSense_SENSOR_CENTRE__BTN    (4u)
#define CapSense_SENSOR_RADIALSLIDER0_E0__RS    (5u)
#define CapSense_SENSOR_RADIALSLIDER0_E1__RS    (6u)
#define CapSense_SENSOR_RADIALSLIDER0_E2__RS    (7u)
#define CapSense_SENSOR_RADIALSLIDER0_E3__RS    (8u)
#define CapSense_SENSOR_RADIALSLIDER0_E4__RS    (9u)
#define CapSense_SENSOR_RADIALSLIDER0_E5__RS    (10u)
#define CapSense_SENSOR_RADIALSLIDER0_E6__RS    (11u)
#define CapSense_SENSOR_RADIALSLIDER0_E7__RS    (12u)
...
#define CapSense_PORT_PIN_CONFIG_TBL_ZISE   (13u)
...
#define CapSense_RESOLUTIONS_TBL_SIZE       (6u)
