...
extern const uint8 CYCODE USBFS_DEVICE0_CONFIGURATION0_DESCR[59u];
...
extern const uint8 CYCODE USBFS_STRING_DESCRIPTORS[329u];
...
extern const uint8 CYCODE USBFS_HIDREPORT_DESCRIPTOR2[71u];
